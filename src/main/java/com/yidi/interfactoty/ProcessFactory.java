...
public interface ProcessFactory {
	...
	ReturnInfo getReturnMSG(Map<Set<Integer>, ParameterSolution> parameter_solutionlist,Map<Integer, Parameter> parameters,AboutSolutionDAO solutiondao,ProcessFactory process);
}
